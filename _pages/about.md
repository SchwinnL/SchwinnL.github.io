...
- May, 2025: We are presenting **2** papers at **ICML 2025**, How to make your time-series transformer and state-space model efficient: [Efficient Adversarial Training in LLMs with Continuous Attacks
](https://arxiv.org/abs/2405.15589), and we formalize the question "When to retrain a machine learning model" in real-world environments where new data is constantly arriving and changing.
