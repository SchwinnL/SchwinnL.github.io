...
](https://arxiv.org/abs/2507.04219), and showcasing the importance of probabilistic evaluations and sampling in adversarial attacks in LLMs [Sampling-aware Adversarial Attacks Against Large Language Models](https://arxiv.org/abs/2507.04446). Additionally, two of our TMLR papers were selected for the journal to conference track: assessing image classifier robustness against semantic adversarial examples generated via score-based diffusion models in [Assessing Robustness via Score-Based Adversarial Image Generation](https://arxiv.org/abs/2310.04285), and improving the robustness of Graph Transformers in [Adversarial Robustness of Graph Transformers](https://openreview.net/forum?id=leFBpvYaPx). 
