...
I'm a Lecturer at the Technical University of Munich, supervising and co-supervising 4 PhD students. Additionally, I am affiliated with the [Mila Quebec AI Institute](https://mila.quebec/en/person/leo-schwinn/) as an independent visiting researcher with Prof. Gauthier Gidel. I am interested in robust machine learning with a focus on data-efficient learning and robustness vulnerabilities of Large Language Models (LLMs). I am currently the main organizer of the ICLR BlogPost Track and am always happy to answer questions about the track. 

Previously, I did my Ph.D. at Friedrich-Alexander University Erlangen-Nürnberg (FAU) under the supervision of Prof. Björn Eskofier, receiving the [ATE dissertation price](https://www.tf.fau.de/2024/11/allgemein/verleihung-der-promotionspreise-2024/). During my PhD I conducted an internship under the supervision of Prof. Doina Precup at the Mila Quebec AI Institute. After my PhD, I worked as a Postdoc at FAU and as a machine learning engineer at Robert Bosch on robust computer vision for autonomous driving. 

### News

- April, 2026: **3** papers accepted at **ICML 2026**! Two AI safety works highlighting weaknesses in current LLM robustness evaluations, [LLM-Safety Evaluations Lack Robustness](https://arxiv.org/abs/2503.02574) and [A Coin Flip for Safety: LLM Judges Fail to Reliably Measure Adversarial Robustness](https://arxiv.org/abs/2603.06594), and we introduce a tokenization scheme for efficient time-series forecasting in [Byte Pair Encoding for Efficient Time Series Forecasting](https://arxiv.org/abs/2505.14411).

- January, 2026: **4** papers accepted at **ICLR 2026**, Converting a bug into a feature by using model collapse as a reliable machine unlearning technique for LLMs in [Model Collapse Is Not a Bug but a Feature in Machine Unlearning for LLMs
](https://arxiv.org/abs/2507.04219), showcasing the importance of probabilistic evaluations and sampling in adversarial attacks in LLMs [Sampling-aware Adversarial Attacks Against Large Language Models](https://arxiv.org/abs/2507.04446), assessing image classifier robustness against semantic adversarial examples generated via score-based diffusion models in [Assessing Robustness via Score-Based Adversarial Image Generation](https://arxiv.org/abs/2310.04285), and one of our TMLR papers on how to improve robustness of Graph Transformers: [Adversarial Robustness of Graph Transformers](https://openreview.net/forum?id=leFBpvYaPx) was selected for the journal to conference track. 
